...
import ckeditor5Icon from './ckeditor.svg';
    ...
    init() {
        ...
        editor.ui.componentFactory.add( 'myButton', locale => {
          ...
          this.listenTo( view, 'execute', () => {
            const response = editor.config.get( 'products' ).createJupyter();
            editor.execute('insertProduct', 255, () => console.log("nani", response));
